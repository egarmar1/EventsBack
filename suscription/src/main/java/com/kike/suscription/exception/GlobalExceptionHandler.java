...
import com.kike.suscription.dto.ErrorResponseDto;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<ErrorResponseDto> handleGlobalException(Exception exc, WebRequest webReq){
        log.info("Executing globalExceptionHandler for exception");
    ...
    public ResponseEntity<ErrorResponseDto> handleFeignExceptionNotFound(Exception exc, WebRequest webReq){
        log.info("Executing exceptionHandler for FeignException");
